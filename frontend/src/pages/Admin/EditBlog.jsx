...
function EditBlog() {
  ...
  if (loading) {
    return (
      <section className="min-h-screen bg-[#FFFFFF] py-6 sm:py-12 flex items-center justify-center">
        <p className="text-sm sm:text-base text-[#9CA3AF]">Loading...</p>
      </section>
    );
  }
      ...
      <div className="max-w-[1000px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-6 sm:mb-8">
          <h1 className="text-[28px] sm:text-[40px] leading-[1.2] font-light text-[#0A0A0A]">
            Edit <span className="text-[#9CA3AF]">Blog</span>
          </h1>
          <p className="text-sm sm:text-base text-[#6B7280]">Update blog post details</p>
        </div>
